...
class DataLoaderIAM:
    ...
    def get_train_samples(self):
        length_train= len(self.train_samples)
        img= [self._get_img(i) for i in range(length_train)]
        gt_texts = [self.train_samples[i].gt_text for i in range(length_train)]
        
        return (img,gt_texts)
    
    def get_valid_samples(self):
        length_val= len(self.validation_samples)
        img= [self._get_img(i) for i in range(length_val)]
        gt_texts = [self.validation_samples[i].gt_text for i in  range(length_val)]
